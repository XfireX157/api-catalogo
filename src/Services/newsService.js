...
export const update = (id, filename, title, path, description, price, discount) => News.findByIdAndUpdate({_id: id}, {filename, title, path ,description, price, discount}, {new: true})
